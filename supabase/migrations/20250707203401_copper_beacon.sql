/*
  # Create Sample Blog Posts with Rough Notation

  1. New Data
    - Sample blog posts demonstrating rough notation features
    - Various highlighting styles and use cases
    - Real-world content examples

  2. Content Features
    - Highlight important concepts
    - Underline key terms
    - Circle critical points
    - Box code snippets
    - Cross-off outdated information
    - Bracket side notes
*/

-- Insert sample blog posts with rough notation examples
